itcl::class Obj {
    ...
    public method draginitcmd {src x y toplevelSymbol}
...
itcl::body Obj::specificLayout {} {return ""}

itcl::body Obj::afterLayout {} {return ""}

itcl::body Obj::mkWindow {{parentw ""}} {
    if {$parentw == ""} {
...
itcl::body Obj::draginitcmd {src x y toplevelSymbol} {
...
itcl::body Obj::dragendcmd {src target op type data dropResult} {
...
itcl::body Obj::dropcmd {target src x y op type data} {
    if {! [catch {$container isa Dim} isaDim]} {if {$isaDim} {
...
itcl::body Obj::dropovercmd {target src evt x y op type data} {
    if {$evt eq "enter"} {
