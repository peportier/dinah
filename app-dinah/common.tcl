...
# $::dinah::resolutions
# e.g. : set ::dinah::resolutions {2 {"_low" $maxLowWidth $maxLowHeight} {"_high" $maxHighWidth $maxHighHeight}}
proc currentResolutionIndex {} {
    lindex $::dinah::resolutions 0
}

proc currentResolution {} {
    lindex $::dinah::resolutions [lindex [currentResolutionIndex] 0]
}

proc currentResolutionMaxWidth {} {
    lindex $::dinah::resolutions [lindex [currentResolutionIndex] 1]
}

proc currentResolutionMaxHeight {} {
    lindex $::dinah::resolutions [lindex [currentResolutionIndex] 2]
}

proc setCurrentResolutionMaxWidth {newWidth} {
    lset ::dinah::resolutions [currentResolutionIndex] 1 $newWidth
}

proc setCurrentResolutionMaxHeight {newHeight} {
    lset ::dinah::resolutions [currentResolutionIndex] 2 $newHeight
}

proc nextResolution {} {
    if {[currentResolutionIndex] < ([llength $::dinah::resolutions] - 1)} {
        lset ::dinah::resolutions 0 [expr {[currentResolutionIndex] + 1}]
    }
}
